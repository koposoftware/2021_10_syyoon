...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
	...
	<link rel="stylesheet" href="${ pageContext.request.contextPath }/resources/css/dashboard/dashmain.css">
        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              ...
              >
                <div
                  class="p-3 mr-4 text-red-700 bg-red-100 rounded-full dark:text-red-700 dark:bg-red-100"
                >
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                  	...
                  	<c:forEach items="${userList }" var="user" varStatus="loop">
                  		<tr class="text-gray-700 dark:text-gray-400">
	                        ...
	                        <div class="flex items-center text-sm">
	                          ...
	                          <div
	                            class="relative hidden w-8 h-8 mr-3 rounded-full md:block" style="color:#fff;text-align:center;padding-top:7px;background-color:#b5b5b5;"
	                          >
	                            ${loop.index+1 }
	                            <div
	                      ...
	                      <td class="px-4 py-3 text-xs">
	                        <span
	                        	<c:if test="${user.status eq '대출승인' }">
	                        		class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"
	                        	</c:if>
	                        	<c:if test="${user.status eq '대출거절' }">
	                        		class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700"
	                        	</c:if>
	                        	<c:if test="${user.status eq '심사중' }">
              ...
              >
                <span class="flex items-center col-span-3">
                  <%-- Showing 1-${userCnt.total} of 100 --%>
                </span>
