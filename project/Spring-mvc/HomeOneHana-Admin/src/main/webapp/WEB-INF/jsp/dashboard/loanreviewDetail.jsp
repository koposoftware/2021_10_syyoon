        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2" >
              ...
              <div>
                <div
                class="flex" style="justify-content:center;"
              >
              <div>
                  <button id="accept"  data-toggle="modal" data-target="#exampleModalCenter"
                    class="resultBtn active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                  >
                    승   인
                  </button>
                </div>
                <div>
                  <button id="reject" data-toggle="modal" data-target="#exampleModalCenter"
                    class="resultBtn active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                  >
                    거   절
                  </button>
                          ...
                          <div class="col-12">
                              ...
                              <div class="apland-timeline-area">
                                  ...
                                  <div class="single-timeline-area">
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-6 col-lg-4">
                                              <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.3s" style="width:400px; visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft;display:flex;">
                                  ...
                                  <div class="single-timeline-area">
                                    ...
                                    <div class="row">
                                      <div class="col-12 col-md-6 col-lg-4">
                                          <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.5s" style="width:400px; visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft; display:flex;">
                                ...
                                <div class="single-timeline-area">
                                  ...
                                  <div class="row">
                                      <div class="col-12 col-md-6 col-lg-4">
                                          <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.7s" style="width:400px; visibility: visible; animation-delay: 0.7s; animation-name: fadeInLeft; display:flex;">
                            ...
                            <div style="margin-top:25px; text-align:center;">
			                  <button id="downloads"
			                    class="active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
			                  >
			                    전체 다운로드
			                  </button>
			                </div>
