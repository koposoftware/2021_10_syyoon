                    ...
                    <div id="customerInfo" class="col-lg-6 m-15px-tb">
                        <div id="customerInput" class="resume-box">
                            ...
                            <div style="margin-top:20px; margin-bottom:20px; padding:20px;">
                            	...
                            	<div id="condition" class="boxTempl"></div>
                            	
                            	<div class="boxTempl"style="margin-top:10px;text-align:center;">
                           				<button id="sendLimit">대출상품정보전송</button>
                           				<button id="linkSend">대출링크전송</button></div>
                            	</div>
