    ...
    <script src="${ pageContext.request.contextPath }/resources/js/dashboard/init-alpine.js"></script>
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul class="mt-6">
            <li id="dashboard" class="relative px-6 py-3">
          ...
          <ul>
            <li id="loanManage" class="relative px-6 py-3">
              <a
              ...
              >
                ...
                <span class="ml-4">대출관리</span>
              </a>
            </li>
            <li id="calaenderMenu" class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              ...
              >
                ...
                <span class="ml-4">나의일정</span>
              </a>
            </li>
           
            <li id="chatMenu" class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="${ pageContext.request.contextPath }/consult/chat"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
