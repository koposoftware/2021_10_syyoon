			            ...
			            <div class="profile-usermenu">
			                <ul class="nav">
			                    ...
			                    <li class="active">
			                    	<div>
			                        <a href="#">
			                            <i class="icon-home"></i> 지금바로 청약을 연습해보세요! </a>
			                    	</div>
			                    </li>
			                    
			                    <li>
			                        <a href="#">
			                            <i class="icon-info"></i> 행복주택 </a>
			                    </li>
			                    <li>
			                        <a href="#">
			                            <i class="icon-info"></i> 국민임대 </a>
			                    </li>
			                    <li>
			                        <a href="#">
			                            <i class="icon-info"></i> 전세임대 </a>
			                    </li>
			                    <li>
			                        <a href="#">
			                            <i class="icon-info"></i> 청약점수계산 </a>
			                    </li>
			                </ul>
			            </div>
			        </div>
			                        ...
			                        <div role="tabpanel" class="tab-pane active" id="home">
			                            <form method="get" action="${ pageContext.request.contextPath }/subscription">
			                              <div class="form-group" >
			                                ...
			                                <div id="insertdetailinfo">
			                                	<div class="form-group">
			                                		<div class="detailBox">
			                                			<div class="detailtitle">
			                                				<div class="ititle">학교정보</div>
			                                			</div>
				                                		<table class="detailinfotbl" id="schooltbl">
				                                			<tr>
				                                			...
				                                			<tr>
				                                				...
				                                				<td><input type="text" id="addr1" name="schooladdr"><input type="button" class="detailbtn" value="소재지검색" onclick="execDaumPostcode()"></td>
				                                			</tr>
				                                			<tr>
				                                				<th><div class="icontent">학생분류</div></th>
				                                				<td>
				                                					<div class="radioBox">
					                                					<div class="rdoBox"><input type="radio" id="재학생" name="schooltype" value="재학생"><label for="재학생"  class="ranktitle"> 재학생</label></div>
						                                				<div class="rdoBox"><input type="radio" id="복학예정" name="schooltype" value="복학예정"><label for="복학예정"  class="ranktitle"> 복학예정</label></div>
						                                				<div class="rdoBox"><input type="radio" id="입학예정" name="schooltype" value="입학예정"><label for="입학예정"  class="ranktitle"> 입학예정</label></div>
					                                				</div>
					                                			</td>
				                                			</tr>
				                                		</table>
				                                	...
				                                	<div class="detailBox">	
				                                		<div class="detailtitle">
			                                				<div class="ititle">세대원정보</div>
					                                		<div class="isubtitle">
					                                		<span>본인의 주민등록본에 등재된 세대원은 동일세대를, 등재되어있지 않은 세대원은 분리세대를 체크하세요.</span>
					                                		<input type="button" class="detailbtn" value="추가"><input type="button" class="detailbtn" value="삭제"></div>
			                                			</div>
				                                		<table class="detailinfotbl" id="hometbl">
				                                			<thead>
					                                			<tr>
					                                				<th><div class="icontent">신청자와의 관계</div></th>
					                                				<th><div class="icontent">성명</div></th>
					                                				<th><div class="icontent">주민등록번호</div></th>
					                                				<th><div class="icontent">신청자가 속한<br>세대주와의 관계</div></th>
				                                			...
				                                			<tbody>
				                                				<tr>
				                                					...
				                                					<td style="display:flex;">
				                                						<div class="rdoBox"><input type="radio" id="seperate" name="familytype" value="분리세대"><label for="seperate" > 분리세대</label></div>
				                                						<div class="rdoBox"><input type="radio" id="same" name="familytype" value="동일세대"><label for="same" > 동일세대</label></div>
				                                					</td>
				                                			</tbody>
				                                		</table>
				                                	</div>	
				                                	<div class="detailBox" >	
				                                		<div class="detailtitle">
			                                				<div class="ititle">가구원수</div>
			                                			</div>
				                                		<table class="detailinfotbl">
				                                			<tr>
				                                				...
				                                				<td><select>
			                                						...
			                                						<div>임신중인 태아가 있을 경우 <input type="button" class="detailbtn" value="태아수 입력"> 버튼을 눌려주세요
			                                						<input type="text" name="babycnt" > 명</div>
			                                					</td>
				                                			</tr>
				                                		</table>
				                                	...
				                                	<div class="detailBox">	
				                                		<div class="detailtitle">
			                                				<div class="ititle">신청자 인적사항</div>
			                                			</div>
				                                		<input type="button" value="회원가입정보와 동일">
				                                		<table class="detailinfotbl">
				                                		
				                                			<tr>
				                                				<th><div class="icontent">신청자 이름</div></th>
				                                			...
				                                			<tr>
				                                				<th><div class="icontent">주민등록상 주소</div></th>
				                                				<td><input type="text" name="addrs"></td>
				                                			</tr>
				                                			<tr>
				                                				<th><div class="icontent">연락처</div></th>
				                                				<td><input type="text" name="tel"></td>
				                                			</tr>
				                                			<tr>
				                                				<th><div class="icontent">이메일</div></th>
				                                				<td><input type="text" name="email"></td>
				                                			</tr>
				                                			<tr>
			                                				<th><div class="icontent">혼인여부</div></th>
				                                				<td>
				                                					<div style="border:1px solid #008485;"><input type="radio" id="재학생" name="marry" value="N"><label for="재학생"  class="ranktitle"> 미혼</label></div>
				                                					<div style="border:1px solid #008485;"><input type="radio" id="복학예정" name="marry" value="Y"><label for="복학예정"  class="ranktitle"> 기혼</label></div>
				                                				</td>
			                                				</tr>	
				                                		</table>
				                              		</div>
