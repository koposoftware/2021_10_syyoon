...
<script>
	...
	<c:forEach items='${detailinfo}' var="item" varStatus="loop">
		...
		var namehome = hnm.split("(")
		var namehome2 = namehome[0].replace(" ","")

		homeAddrs.set(namehome2,"${item.lgdn_adr}")	
		homenmSet.add(namehome2)
	                    ...
	                    <article class="article">
	                            ...
	                            <div class="media">
	                            	<c:if test="${not empty sessionScope.loginVO }">
		                                <div class="avatar" style="display:flex;position: relative;">
		                                    <button id="favorite" onClick="favorite(this.id)" class="circle"><i class="far fa-heart fa-lg"></i></button>
		                                </div>
	                                </c:if>
	                        ...
	                        <div class="nav tag-cloud">
		                    	...
		                    	<div id="bottomBtns">
		                    		...
		                    		<a class="mapBtn" id="saveBtn" href="#" >페이지 저장하기</a>
