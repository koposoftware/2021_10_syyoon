...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>HomeOneHana::관리자로그인</title>
    <link
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="${ pageContext.request.contextPath }/resources/img/dashboard/login-office.jpeg"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="${ pageContext.request.contextPath }/resources/img/dashboard/login-office-dark.jpeg"
              alt="Office"
            />
          </div>
