...
$(document).ready(function(){
  ...
  verificationForm();
   ...
   $("#contractpaper").change(function(){
		$('.file_added>li').append('<li><a href="#"><i class="ion-paperclip"></i>'+$(this)[0].files[0].name+'</a></li>')
    	$(this).siblings().css({backgroundColor:'rgba(0,140,140,.2)' })
		$(this).siblings().animate({width:'100%'},3000,'swing')
